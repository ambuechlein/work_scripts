...
next if($component eq 'create_subset_orthodb' or $component eq 'remove_empty_sequence' or $component eq 'cdbfasta' or $component eq 'blast2xml' or $component eq 'bsml2fasta' or $component eq 'rpsblast' or $component eq 'bsml2featurerelationships' or $component eq 'start_site_curation' or $component eq 'ber' or $component eq 'bsml2promoterregion' or $component eq 'formatdb' or $component eq 'asn2all' or $component eq 'concatenate_files' or $component eq 'annot2gaf' or $component eq 'p_func' or $component eq 'gbk2ptt' or $component eq 'tRNAscan-SE' );

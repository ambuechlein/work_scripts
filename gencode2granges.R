...
chrom.info=read.table(file="/nfs/bio/db/Homo_sapien/gencode_v19/chrSizes.tsv", header=T)
# Create the transcriptdb from the gencode gtf file
# Download the latest gencode comprehensive gtf file from gencode website
gencode<-makeTranscriptDbFromGFF("/nfs/bio/db/Homo_sapien/gencode_v19/gencode.v19.annotation.gtf", 
...
saveDb(gencode, file="/nfs/bio/db/Homo_sapien/gencode_v19/reg_elements/gencode_human_v19.sqlite")
loadDb("/nfs/bio/db/Homo_sapien/gencode_v19/reg_elements/gencode_human_v19.sqlite")
...
save(genes.gencode,intergenic.gencode,transcript.gencode,cds.gencode,exons.gencode,introns.gencode, file="/nfs/bio/db/Homo_sapien/gencode_v19/reg_elements/gencode_all_features.rda")
# Load the database in future
load("/nfs/bio/db/Homo_sapien/gencode_v19/reg_elements/gencode_all_features.rda")
...
save(annotation.all.features, file="/nfs/bio/db/Homo_sapien/gencode_v19/reg_elements/gencode_all_features_list.rda")
# Load in future
load("/nfs/bio/db/Homo_sapien/gencode_v19/reg_elements/gencode_all_features_list.rda")

...
#  my $command = 'tophat2 -o '.$outdir.' --transcriptome-index=/nfs/labs/nephew/human_databases/gencode_v23/transcriptome-index -p 8 --b2-very-sensitive --read-edit-dist 2 --max-multihits 100 --library-type fr-secondstrand /nfs/labs/nephew/human_databases/gencode_v23/genome ' . $file;
  my $command = 'tophat2 -o '.$outdir.' --transcriptome-index=/nfs/labs/nephew/human_databases/gencode_v26/transcriptome-index -p 8 --b2-very-sensitive --read-edit-dist 2 --max-multihits 100 --library-type fr-secondstrand /nfs/labs/nephew/human_databases/gencode_v26/genome ' . $file;

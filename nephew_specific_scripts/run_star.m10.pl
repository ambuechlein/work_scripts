...
# GSF1016-polyA-3591_S4_R1_001.fastq.gz
  ...
  my $command = "/home/abuechle/bin/STAR/bin/Linux_x86_64/STAR --runThreadN 8 --outReadsUnmapped Fastx --genomeDir /nfs/labs/nephew/human_databases/gencode_m10_chrOnly/ --readFilesIn $file --readFilesCommand zcat --outFilterMultimapNmax 25 --outFileNamePrefix $outdir/ --outSAMtype BAM SortedByCoordinate --quantMode GeneCounts";

...
echo "Converting bam files to bed files"
./bam2bed.sh

echo "Converting bed files to density files"
./bed2density.sh

echo "Splitting density files based on individual chromosomes for efficient memory management"
./splitByChr.sh
